                    ...
                    >
                      <div className="flex items-center gap-1">
                        <input
                          ...
                          className="w-full bg-transparent text-xs font-semibold text-text-primary font-display outline-none focus-visible:ring-2 focus-visible:ring-accent/40 focus-visible:ring-offset-1 focus-visible:ring-offset-surface rounded px-1 py-0.5"
                        />
                        <button
                      ...
                      return (
                        ...
                        >
                          <input
                            ...
                            className={clsx(
                              "w-full bg-transparent px-2 py-1.5 text-sm text-text-primary outline-none focus-visible:ring-2 focus-visible:ring-accent/40 focus-visible:ring-offset-1 focus-visible:ring-offset-surface focus:bg-accent/[0.04] rounded-sm",
                            )}
                          />
                        </td>
                      );
