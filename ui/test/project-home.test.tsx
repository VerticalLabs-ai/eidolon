...
vi.mock('@/lib/ws', () => ({ useServerEvents: vi.fn() }));
  ...
  recentActivity: [
    {
      ...
      entityType: 'task',
      entityId: 'task-1',
      description: 'Task created: Fix race condition',
      metadata: {},
  ...
  recentFiles: [
    {
      ...
      updatedAt: '2026-07-31T10:00:00.00.000Z',
    },
  ],
